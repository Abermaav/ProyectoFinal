...
public class Venti extends JFrame implements ActionListener {
    ...
    Venti() {
        ...
        ImageIcon icon = new ImageIcon("src/Venti.png");
        ...
        JLabel descripcion = new JLabel("<html>Venti<br>Es el arconte de mondstad y es el dios de la libertad<br>Utiliza el elemento anemo y su arma es el arco</html>");
