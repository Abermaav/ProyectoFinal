...
public class Nahida extends JFrame implements ActionListener {
    ...
    Nahida() {
        ...
        ImageIcon icon = new ImageIcon("src/Nahida.png");
        ...
        JLabel descripcion = new JLabel("<html>Nahida<br>Es la arconte de sumeru y diosa de la sabiduria<br>Utiliza catalizador y domina el elemento dendro</html>");
